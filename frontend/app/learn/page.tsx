  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-12">
        <div className="mb-10">
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">How TrendSignal Works</h1>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-bold text-slate-900 mb-3">Current Momentum</h2>
        ...
        {/* Peak Momentum */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-slate-900 mb-3">Peak Momentum</h2>
          <div className="text-sm text-slate-600 space-y-2 leading-relaxed">
            <p>
            ...
            <p>
              The percentage shown next to peak momentum (e.g., <span className="font-mono text-slate-500">72%</span>)
        ...
        {/* Lifecycle Stage */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-slate-900 mb-3">Lifecycle Stage</h2>
          <div className="text-sm text-slate-600 space-y-2 leading-relaxed">
            <p>
          ...
          <div className="grid gap-3 mt-4">
            <div className="flex items-start gap-3 p-3 border border-slate-200 rounded-lg">
              <span className="shrink-0 px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-700">Emerging</span>
            ...
            <div className="flex items-start gap-3 p-3 border border-slate-200 rounded-lg">
              <span className="shrink-0 px-2 py-0.5 rounded text-xs font-medium bg-emerald-100 text-emerald-700">Rising</span>
              <p className="text-sm text-slate-600">
            ...
            <div className="flex items-start gap-3 p-3 border border-slate-200 rounded-lg">
              <span className="shrink-0 px-2 py-0.5 rounded text-xs font-medium bg-amber-100 text-amber-700">Peaking</span>
              <p className="text-sm text-slate-600">
            ...
            <div className="flex items-start gap-3 p-3 border border-slate-200 rounded-lg">
              <span className="shrink-0 px-2 py-0.5 rounded text-xs font-medium bg-slate-100 text-slate-600">Stable</span>
              <p className="text-sm text-slate-600">
            ...
            <div className="flex items-start gap-3 p-3 border border-slate-200 rounded-lg">
              <span className="shrink-0 px-2 py-0.5 rounded text-xs font-medium bg-red-100 text-red-700">Declining</span>
              <p className="text-sm text-slate-600">
            ...
            <div className="flex items-start gap-3 p-3 border border-slate-200 rounded-lg">
              <span className="shrink-0 px-2 py-0.5 rounded text-xs font-medium bg-slate-100 text-slate-500">Fading</span>
              <p className="text-sm text-slate-600">
        ...
        {/* Qualified Status */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-slate-900 mb-3">Qualified Status</h2>
          <div className="text-sm text-slate-600 space-y-2 leading-relaxed">
            <p>
          ...
          <div className="mt-3 space-y-2">
            <div className="flex items-start gap-2 text-sm text-slate-600">
              <span className="shrink-0 mt-0.5 w-5 h-5 rounded bg-slate-900 text-white flex items-center justify-center text-[11px] font-bold">1</span>
            ...
            <div className="flex items-start gap-2 text-sm text-slate-600">
              <span className="shrink-0 mt-0.5 w-5 h-5 rounded bg-slate-900 text-white flex items-center justify-center text-[11px] font-bold">2</span>
            ...
            <div className="flex items-start gap-2 text-sm text-slate-600">
              <span className="shrink-0 mt-0.5 w-5 h-5 rounded bg-slate-900 text-white flex items-center justify-center text-[11px] font-bold">3</span>
              <p><strong>Actionability</strong> — The system can suggest a specific, buildable action (not just &quot;this is popular&quot;).</p>
            </div>
            <div className="flex items-start gap-2 text-sm text-slate-600">
              <span className="shrink-0 mt-0.5 w-5 h-5 rounded bg-slate-900 text-white flex items-center justify-center text-[11px] font-bold">4</span>
        ...
        {/* Signals */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-slate-900 mb-3">Signals</h2>
          <div className="text-sm text-slate-600 space-y-2 leading-relaxed">
            <p>
        ...
        {/* Timing & Competition */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-slate-900 mb-3">Timing & Competition</h2>
          <div className="text-sm text-slate-600 space-y-2 leading-relaxed">
            <p>
          ...
          <div className="grid gap-4 mt-4 md:grid-cols-2">
            <div className="p-4 border border-slate-200 rounded-lg">
              <h3 className="text-sm font-semibold text-slate-900 mb-2">Timing Intelligence</h3>
            ...
            <div className="p-4 border border-slate-200 rounded-lg">
              <h3 className="text-sm font-semibold text-slate-900 mb-2">Competition Analysis</h3>
              <p className="text-sm text-slate-500 leading-relaxed">
        ...
        {/* Pipeline Overview */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-slate-900 mb-3">The Pipeline</h2>
          <div className="text-sm text-slate-600 space-y-2 leading-relaxed">
            <p>
              Every day, TrendSignal runs a 6-stage pipeline that transforms raw community data
          ...
          <ol className="mt-4 space-y-3">
            {[
              ...
              <li key={i} className="flex gap-3 text-sm">
                <span className="shrink-0 w-6 h-6 rounded bg-slate-900 text-white flex items-center justify-center text-xs font-bold">
                  {i + 1}
                </span>
                <div>
