        ...
        <section className="mb-10">
          ...
          <div className="grid gap-3 mt-4">
            <div className="flex items-start gap-3 p-3 border border-slate-200 rounded-lg">
              <span className="shrink-0 px-2 py-0.5 rounded text-xs font-medium bg-blue-50 text-blue-700">Emerging</span>
            ...
            <div className="flex items-start gap-3 p-3 border border-slate-200 rounded-lg">
              <span className="shrink-0 px-2 py-0.5 rounded text-xs font-medium bg-emerald-50 text-emerald-700">Rising</span>
              <p className="text-sm text-slate-600">
            ...
            <div className="flex items-start gap-3 p-3 border border-slate-200 rounded-lg">
              <span className="shrink-0 px-2 py-0.5 rounded text-xs font-medium bg-amber-50 text-amber-700">Peaking</span>
              <p className="text-sm text-slate-600">
            ...
            <div className="flex items-start gap-3 p-3 border border-slate-200 rounded-lg">
              <span className="shrink-0 px-2 py-0.5 rounded text-xs font-medium bg-red-50 text-red-700">Declining</span>
              <p className="text-sm text-slate-600">
            ...
            <div className="flex items-start gap-3 p-3 border border-slate-200 rounded-lg">
              <span className="shrink-0 px-2 py-0.5 rounded text-xs font-medium bg-slate-50 text-slate-500">Fading</span>
              <p className="text-sm text-slate-600">
        ...
        <section className="mb-10">
          ...
          <div className="mt-3 space-y-2">
            <div className="flex items-start gap-2 text-sm text-slate-600">
              <span className="shrink-0 mt-0.5 w-5 h-5 rounded bg-indigo-600 text-white flex items-center justify-center text-[11px] font-bold">1</span>
            ...
            <div className="flex items-start gap-2 text-sm text-slate-600">
              <span className="shrink-0 mt-0.5 w-5 h-5 rounded bg-indigo-600 text-white flex items-center justify-center text-[11px] font-bold">2</span>
            ...
            <div className="flex items-start gap-2 text-sm text-slate-600">
              <span className="shrink-0 mt-0.5 w-5 h-5 rounded bg-indigo-600 text-white flex items-center justify-center text-[11px] font-bold">3</span>
              <p><strong>Actionability</strong> — The system can suggest a specific, buildable action (not just &quot;this is popular&quot;).</p>
            </div>
            <div className="flex items-start gap-2 text-sm text-slate-600">
              <span className="shrink-0 mt-0.5 w-5 h-5 rounded bg-indigo-600 text-white flex items-center justify-center text-[11px] font-bold">4</span>
          ...
          <ol className="mt-4 space-y-3">
            {[
              ...
              <li key={i} className="flex gap-3 text-sm">
                <span className="shrink-0 w-6 h-6 rounded bg-indigo-600 text-white flex items-center justify-center text-xs font-bold">
                  {i + 1}
                </span>
                <div>
